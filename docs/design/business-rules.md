...
| BR-16 | ☑ | `SavingCore.sol:113-120` `VaultManager.sol:51` | `pause()`/`unpause()` on both contracts; `whenNotPaused` on `withdrawAtMaturity`, `claimInterest`, `renewDeposit`, `autoRenewDeposit` |
